...
function WhatsAppFloat() {
  ...
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.95 }}
      className="flex fixed bottom-24 right-6 lg:bottom-8 lg:right-[104px] z-50 w-14 h-14 bg-[#25D366] rounded-full items-center justify-center shadow-[0_4px_15px_rgba(37,211,102,0.4)] hover:shadow-[0_6px_25px_rgba(37,211,102,0.6)] transition-all duration-300"
...
function CallFloat() {
  ...
  return (
    <motion.a
      ...
      whileHover={{ scale: 1.1 }}
      whileTap={{ scale: 0.95 }}
      className="flex fixed bottom-40 right-6 lg:bottom-[104px] lg:right-8 z-50 w-14 h-14 bg-[#5AB9EA] rounded-full items-center justify-center shadow-[0_4px_15px_rgba(90,185,234,0.4)] hover:shadow-[0_6px_25px_rgba(90,185,234,0.6)] transition-all duration-300 group"
      aria-label="Call Us"
      id="floating-call"
    >
      <Phone size={24} color="white" className="group-hover:scale-110 transition-transform duration-300" />
    </motion.a>
  );
}

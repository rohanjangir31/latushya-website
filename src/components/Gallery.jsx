  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 lg:px-16">
        <SectionHeader
          label="Our Gallery"
          title={<>Wardrobes That <span className="italic text-gold">Inspire</span></>}
          subtitle="A visual journey through our wardrobe work — every image tells a story of craftsmanship and precision."
        />
        ...
        <StaggerContainer className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
          {GALLERY_IMAGES.map((image, i) => (
            ...
            >
              ...
              {/* Hover overlay */}
              <div className="absolute inset-0 bg-black-deep/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
              ...
              {/* Category tag */}
              <div className="absolute top-3 left-3 bg-black-deep/70 backdrop-blur-sm px-3 py-1 opacity-0 group-hover:opacity-100 transition-opacity duration-300">

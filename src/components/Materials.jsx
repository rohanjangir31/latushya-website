...
const CATEGORY_LABELS = {
  ...
  Substrate: { num: '02', title: 'Structural Cores', description: 'The hidden layers dictate the lifespan of your interiors. We use boiling-water-proof (BWP) and moisture-resistant architectural-grade substrates engineered to withstand impact and the test of time.' },
};

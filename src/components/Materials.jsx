...
const CATEGORY_LABELS = {
  ...
  Substrate: { num: '02', title: 'Structural Cores', description: 'The hidden layers dictate the lifespan of your interiors. We use boiling-water-proof (BWP), architectural-grade substrates that resist moisture, impact, and time.' },
};

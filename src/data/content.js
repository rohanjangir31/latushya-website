...
export const GALLERY_IMAGES = [
  ...
  // New Client Uploads (Strictly Deduplicated)
  ...
  { id: 11, src: '/gallery-new/photo-13.jpg', alt: 'Elegant Wood & Texture Finishes', category: 'Recent Projects', isPlaceholder: false },
  { id: 12, src: '/gallery-new/photo-25.jpg', alt: 'Luxury Home Details', category: 'Recent Projects', isPlaceholder: false },
  { id: 13, src: '/gallery-new/photo-14.jpg', alt: 'Modern Living Aesthetics', category: 'Recent Projects', isPlaceholder: false },
  { id: 14, src: '/gallery-new/photo-33.jpg', alt: 'Refined Turnkey Execution', category: 'Recent Projects', isPlaceholder: false },
  { id: 15, src: '/gallery-new/photo-20.jpg', alt: 'Bespoke Custom Furniture', category: 'Recent Projects', isPlaceholder: false },
  { id: 16, src: '/gallery-new/photo-19.jpg', alt: 'Sophisticated Wardrobe System', category: 'Recent Projects', isPlaceholder: false },
  { id: 17, src: '/gallery-new/photo-27.jpg', alt: 'Tailored Lighting & Ambiance', category: 'Recent Projects', isPlaceholder: false },
  { id: 18, src: '/gallery-new/photo-17.jpg', alt: 'Minimalist Modular Aesthetics', category: 'Recent Projects', isPlaceholder: false },
  { id: 19, src: '/gallery-new/photo-16.jpg', alt: 'Custom Built Storage', category: 'Recent Projects', isPlaceholder: false },
  { id: 20, src: '/gallery-new/photo-18.jpg', alt: 'Turnkey Design Integration', category: 'Recent Projects', isPlaceholder: false },
];

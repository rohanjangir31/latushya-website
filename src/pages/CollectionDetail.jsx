        ...
        {designs.length > 0 && (
          <section className="max-w-[1600px] mx-auto px-6 lg:px-12">
            ...
            <div className="relative w-full max-w-4xl mx-auto flex flex-col items-center pb-12">
              ...
              <div className="w-[95%] md:w-[85%] lg:w-[75%] bg-black/40 border border-white/10 p-8 lg:p-12 rounded-2xl relative z-20 mt-8 md:mt-12 md:self-start md:ml-8 lg:ml-12 shadow-2xl transition-all duration-700 flex flex-col items-start text-left">
                <AnimatePresence mode="wait">
                  <motion.div 
